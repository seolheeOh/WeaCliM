...
from utils_src import mse, lonlat_to_grid
...
for inp_month in ['apr', 'oct']:
    ...
    oname = f'ref_cnn_monthly_mse_{inp_month}_{target_month}_gpcp_2000-2019'
    opath = 'data/skills/'
    ...
    ipath = 'data/reconst/'
    f = Dataset(ipath+f'ref_cnn_monthly_{inp_month}_{target_month}_gpcp_2000-2019.nc','r')
